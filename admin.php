...
<?php 
    ...
    if (!empty($_SESSION["user_id"])) {
        ...
        if(in_array(1,$currentUserRoles)){
            ...
            if(isset($_POST['InactiveUserId']) && $_POST['method'] == 'delete') {
            ...
            }else if(isset($_POST['userId']) && ($_POST['method'] == 'addRole' || $_POST['method'] == 'deleteRole')){
                                        ...
                                        <div class="modal-dialog" role="document">
                                            ...
                                            <div class="modal-footer">
                                                <form role="form" action="'.$_SERVER['REQUEST_URI'].'" method="post">
                                                    ...
                                                    <button type="submit" id="inactiveBtn" class="danger btn btn-danger" >Delete</button>
                                                </form>
